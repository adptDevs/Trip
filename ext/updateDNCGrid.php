...
function add_row($cn){
	...
	$sql = 	"INSERT INTO doNotContact(fullname,address,address2,city,state,zipcode,plus4,notes,action)
			VALUES ('".$_POST["c0"]."',
					'".$_POST["c1"]."',
					'".$_POST["c2"]."',
					'".$_POST["c3"]."',
...
function update_row($cn){
	$sql = 	"UPDATE doNotContact SET  fullname='".$_POST["c0"]."',
					address='".$_POST["c1"]."',
					address2='".$_POST["c2"]."',
					city='".$_POST["c3"]."',
					state='".$_POST["c4"]."',
...
function delete_row($cn){
	...
	$d_sql = "DELETE FROM doNotContact WHERE id=".$_POST["gr_id"];
