...
function add_row($cn){
	...
	$sql = 	"INSERT INTO blacklistAddresses(address,address2,city,state,zipcode,plus4,notes,action)
			VALUES ('".$_POST["c0"]."',
					'".$_POST["c1"]."',
					'".$_POST["c2"]."',
					'".$_POST["c3"]."',
...
function update_row($cn){
	$sql = 	"UPDATE blacklistAddresses SET address='".$_POST["c0"]."',
				address2=		'".$_POST["c1"]."',
				city= '".$_POST["c2"]."',
				state= '".$_POST["c3"]."',
				zipcode= '".$_POST["c4"]."',
...
function delete_row($cn){
	...
	$d_sql = "DELETE FROM blacklistAddresses WHERE id=".$_POST["gr_id"];
